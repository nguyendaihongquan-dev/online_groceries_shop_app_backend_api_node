...
module.exports.controller = (app, io, socket_list) => {
     ...
     *   post:
     *     summary: User login
     *     description: Authenticates a user and returns auth token
     *     tags: [Authentication]
     *     requestBody:
     *       required: true
     *       content:
     ...
     *                 message:
     *                   type: string
     *                   example: this email already register
     */
    ...
    /**
     * @swagger
     * /api/app/get_zone_area:
     *   post:
     *     summary: Get zones and areas
     *     description: Returns a list of all delivery zones and their associated areas
     *     tags: [Location]
     *     responses:
     *       200:
     *         description: List of zones and areas
     *         content:
     *           application/json:
     *             schema:
     *               type: object
